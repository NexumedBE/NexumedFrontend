...
const BetaTestAgreement = ({ onAccept }) => {
  ...
  const today30 = todayPlus30.toLocaleDateString();
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white rounded-lg shadow-lg w-3/4 h-[400px] p-6 overflow-y-auto">
        <div className="flex justify-between items-center border-b pb-2">
          <h2 className="text-lg font-semibold">
            License Overeenkomst - {today}
          </h2>
        </div>
        <div className="p-4 border mt-4">
          ...
          <p className="text-[12px] mb-[5px]">
            <strong>3. Beëindiging:</strong> De hieronder verleende licenties en deze Overeenkomst eindigen bij het verstrijken van de BETA-testperiode, welke eindigt op {today30}. Bovendien kan elke partij deze Overeenkomst ten allen tijde beëindigen na schriftelijke kennisgeving aan de andere partij en met inachtneming van een opzegtermijn van één (1) kalenderweek. Binnen vijf dagen na beëindiging zal de Tester (i) de Software en alle kopieën daarvan aan Nexumed teruggeven in de door Nexumed verstrekte vorm of (ii) op verzoek van Nexumed de Software en alle kopieën daarvan vernietigen en schriftelijk bevestigen dat deze zijn vernietigd. Artikelen 2 tot en met 10 blijven van kracht na  
beëindiging van deze Overeenkomst. 
        ...
        <div className="mt-4">
          <label className="flex items-center space-x-2">
            ...
            />
            <span>Ik ga akkoord met de License overeenkomst</span>
          </label>
        </div>
