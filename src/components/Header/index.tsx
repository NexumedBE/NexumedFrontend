...
const Header = () => {
  ...
  // Filter menu to show profile and subscription links only if user is authenticated
  const filteredMenuData = state.isAuthenticated
    ? menuData
    : menuData.filter((menuItem) => menuItem.title !== "Profile" && menuItem.title !== "Subscription" && menuItem.title !== "Configuration");
